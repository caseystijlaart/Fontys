# Prototype (local) — Personalized Plant Monitoring

This folder contains the local prototype, evolved from the POF-03 proof of concept (`src/legacy/pof-03`). It keeps the personalization + settings-management features and TinyML-ready ESP32 integration, and logs cycles to a cloud endpoint over WiFi (no local MQTT/cloud broker dependency).
