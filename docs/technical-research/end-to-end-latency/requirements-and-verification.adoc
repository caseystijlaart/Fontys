...
| Dependencies
| Radar frame rate in the 10-20Hz base range (<<mmwave-radar>>, <<tidue71d,2020>>). Inference ≤ 5ms (simple approach) or ≤ 50ms (ML fallback); both theoretical. No competing background process during measurement.
|===
