...
A top level overview is given in <<fig-project-top-level>>.
...
The final deliverable will be a working embedded prototype that demonstrates the system's capabilities, along with the supporting documentation, including a technical research report covering sensor selection, implemented interaction logic (position + height output), and a system architecture document. 
...
[[fig-project-top-level]]
.Project Top Level Overview
[graphviz, project-overvieww, png]
....
digraph ProjectOverview {
  rankdir=LR;
  node [shape=box, fontname="Helvetica", fontsize=10];

  "Human Occupancy" -> "Sensing System"
  "Speaker Detection" -> "Sensing System"
  "Virtual Human" -> "Sensing System"
  "Sensing System" -> "Virtual Human"
}
....