...
The research strategies are field, lab, library, workshop, and showroom.
...
The strategies and techniques are chosen based on the nature of the question, the available resources, and the desired outcome:

image::methods.png[Research strategies and techniques,align="center"]

For a comprehensive view of how the DOT-framework strategies align with each research question
(see xref:research-questions.adoc[Research Questions]), consult the table below.
