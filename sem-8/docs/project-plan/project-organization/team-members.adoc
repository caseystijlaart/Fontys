...
|Experience Design intern | R. Lengton |MindLabs |Design and behaviour of the Virtual Human; joint alignment on interaction requirements the sensing system must support
|Fontys examiner / assessor | G. Elbers |Fontys ICT |Academic supervision and assessment of the internship

|===

Additional MindLabs team members with technical backgrounds in embedded systems, sensor
integration, and software architecture are available to support the technical depth of the
project alongside the company mentor's interaction-design guidance.
